          ...
          child: Column(
            children: [
              Row(
                ...
                children: [
                   Text("Tus Reservas", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 18)),
             ...
             SizedBox(height: 15),
              ...
              FutureBuilder<List<ReservaModelo>>(
                ...
                builder: (context, snapshot) {
                  ...
                  if (listaReal.isEmpty) {
                    return  Text("No hay reservas activas", style: TextStyle(color: Colors.white54));
                  }
                          ...
                          child: Column(
                            children: [
                              Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  Text(reserva.fechaBien, style:  TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
                                  Container(
                                    decoration: BoxDecoration(
                                      borderRadius: BorderRadius.circular(10),
                                      color:  Color.fromARGB(255, 61, 103, 176).withValues(alpha: 0.4),
                                    ),
                                    child:  Padding(
                                      padding: EdgeInsets.all(6.0),
                                      child: Text("CONFIRMADA", style: TextStyle(fontSize: 10, color: Colors.lightBlueAccent)),
                                    ),
                                  ),
                                ],
                              ),
                              Row(
                                children: [
                                  Text(reserva.horaBien, style:  TextStyle(color: Colors.white54, fontSize: 12)),
                                ],
                              ),
                               SizedBox(height: 15),
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(10),
                                  color:  Color.fromARGB(7, 56, 41, 41).withValues(alpha: 0.9),
                                ),
                                child: Padding(
                                  ...
                                  child: Row(
                                    children: [
                                       ...
                                       SizedBox(width: 8),
                                      Text("${reserva.personas} personas", style:  TextStyle(color: Colors.white60)),
                                       SizedBox(width: 15),
                                       Icon(Icons.table_restaurant_outlined, color: Colors.white54),
                                       SizedBox(width: 8),
                                      Text("Mesa ${reserva.mesa}", style:  TextStyle(color: Colors.white60)),
                                       Spacer(),
                                      Text(reserva.codigo , style:  TextStyle(color: Colors.white24, fontSize: 10)),
                                    ],
                                  ),
                                ),
                              ),
                                        ...
                                        bool? confirmar = await showDialog(
                                          ...
                                          builder: (context) => AlertDialog(
                                            ...
                                            actions: [
                                              ...
                                              TextButton(onPressed: () => Navigator.pop(context, true), child: Text("Sí, cancelar")),
                                            ],
                                          ),
                                        );
                                        if (confirmar == true) {
                                          bool exito = await _apiService.eliminarReservacion(reserva.id);
                                          if (exito) {
                                            setState(() {
                                              _operacionReservas = _obtenerReservasReales();
                                            });
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text("Tus Pedidos", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 18)),
              ...
              FutureBuilder<List<Pedido>>(
                ...
                builder: (context, snapshot) {
                  ...
                  if (listaPedidos.isEmpty) {
                    return const Text("No tienes pedidos registrados", style: TextStyle(color: Colors.white54));
                  }
